...
urlpatterns = [
    ...
    re_path(r'^finding/false_positive$', views.false_positive_findings,
        name='false_positive_findings'),
    re_path(r'^finding/out_of_scope$', views.out_of_scope_findings,
        name='out_of_scope_findings'),
    re_path(r'^finding/inactive$', views.inactive_findings,
        name='inactive_findings'),
